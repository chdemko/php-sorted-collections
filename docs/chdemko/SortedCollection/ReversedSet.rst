--------------------------------------
chdemko\\SortedCollection\\ReversedSet
--------------------------------------

.. php:namespace: chdemko\\SortedCollection

.. php:class:: ReversedSet

    Reversed set

    .. php:method:: __construct(SortedSet $set)
    ...
    .. php:method:: create(SortedSet $set)

        Create

        :type $set: SortedSet
        :param $set: Internal set
        :returns: ReversedSet A new reversed set
