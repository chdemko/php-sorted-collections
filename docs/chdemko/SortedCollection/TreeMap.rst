...
.. php:class:: TreeMap
    ...
    .. php:method:: put($traversable = array())
        ...
        :param $traversable: Values to put in the map
        :returns: TreeMap $this for chaining
    ...
    .. php:method:: initialise($traversable = array())
        ...
        :type $traversable: \Traversable
        :param $traversable: Values to initialise the map
        :returns: TreeMap $this for chaining
